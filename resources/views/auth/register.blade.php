    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url({{ asset('assets/images/big/sikasir_login.png') }});">
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        <input class="form-control" name="name" type="text" placeholder="your full name" value="{{ old('name') }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        <input class="form-control" name="store_name" type="text" placeholder="your store name" value="{{ old('store_name') }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
